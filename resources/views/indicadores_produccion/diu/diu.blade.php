...
@section('breadcrumb')
    <nav>
        <ol class="j-bread">
            ...
            <li class="j-bread-item active">Inserción y Retiro de Dispositivo Intrauterino</li>
        </ol>
    </nav>
@endsection
...
@section('content')
   ...
   <div class="container">
      <div class="j-h1">
         <div class="j-h1-w">
            <div class="j-h1-n">10</div>
            <h1>Inserción y Retiro de Dispositivo Intrauterino</h1>
         </div>
      </div>
   </div>
