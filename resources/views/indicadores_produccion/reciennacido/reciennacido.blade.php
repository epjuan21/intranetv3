...
@section('breadcrumb')
    <nav>
        <ol class="j-bread">
            ...
            <li class="j-bread-item active">Consulta de Control por Médico Recién Nacido</li>
        </ol>
    </nav>
@endsection
...
@section('content')
   ...
   <div class="container">
      <div class="j-h1">
         <div class="j-h1-w">
            <div class="j-h1-n">07</div>
            <h1>Recién Nacido - Consulta de Control por Médico Recién Nacido</h1>
         </div>
      </div>
   </div>
